...
1. [Tier 0 — Reveal cơ bản](#tier-0--reveal-cơ-bản-mặc-định-cho-90-nhu-cầu)
2. [Tier 1 — Sticky scene + CSS](#tier-1--sticky-scene--css-scroll-driven-css-only-pagespeed-tối-đa)
3. [Tier 2 — GSAP ScrollTrigger](#tier-2--gsap-scrolltrigger-khi-cần-scrubpintimeline-đồng-bộ-phức-tạp)
4. [Tier 3 — Media scrub](#tier-3--media-scrub-videoảnh-sequence-tua-theo-cuộn-kiểu-apple)
5. [Ngân sách & nghiệm thu](#ngân-sách--nghiệm-thu-riêng-type-này)
6. [Chọn tier nhanh](#chọn-tier-nhanh)
