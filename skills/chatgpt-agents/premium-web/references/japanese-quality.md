...
> Nếu là **code FE của 1 sản phẩm có design system riêng** (vd MEO dashboard) → theo đúng
> design guideline/token của dự án đó, không áp file này. File này dành cho web hướng khách Nhật.
