...
> **Phụ thuộc & fallback:** `jp-requirement` là **optional** — dùng khi runtime có sẵn
> để lấy đúng format bảng so sánh options. Không có → tự dựng bảng 案/メリット/デメリット/
> 推奨 ngay trong tài liệu. Không dừng việc vì thiếu skill kia.
